...
<html lang="en">
   <head>
      ...
      <title><?php if(isset($serial_no)) echo $serial_no."/". date('y-m-d');?></title>
      ...
      <div class="row break">
         <div class="col">
            <table class="table borderless" style="font-size: 12px;">
               ...
               <tbody>
                  <?php foreach($datas as $data):?>
                  <tr id="trid-<?php echo $rowcounter++; ?>" >
                     <td style=""><?php echo  BanglaConverter::en2bn($counter++)?></td>
                     ...
                     <td id=""><?php echo  BanglaConverter::en2bn($data->product_total_price); ?> টাকা</td>
                  </tr>
                  <?php endforeach;?>
                  <?php //endforeach;?>
                  <?php if($counter == 10):?>
